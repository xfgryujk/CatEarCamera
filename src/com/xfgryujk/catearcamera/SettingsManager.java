...
public class SettingsManager {
	...
	public static void initialize(MainActivity mainActivity) {
		...
		mScaleFactor    = pref.getFloat(res.getString(R.string.pref_scale_factor), 1.75f);
	...
	protected static OnItemClickListener mOnDialogItemClick = new OnItemClickListener() {
		...
		public void onItemClick(final AdapterView<?> adapterView, final View view, int position, long id) {
			...
			case 0: // EV
				showSeekBarDialog(res.getString(R.string.EV), params.getMinExposureCompensation(), 
					...
					public void onClick(int progress) {
						...
						((HashMap<String, String>)adapterView.getItemAtPosition(0)).put("value", Integer.toString(mEV));
			...
			case 1: // White balance
				...
				.setItems(whiteBalances.toArray(new String[whiteBalances.size()]), new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialog, int which) {
						...
						((HashMap<String, String>)adapterView.getItemAtPosition(1)).put("value", whiteBalances.get(which));
						mAdapter.notifyDataSetChanged();
				...
				.setItems(sizesString, new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialog, int which) {
						if(which != mResolution)
						{
							...
							((HashMap<String, String>)adapterView.getItemAtPosition(2)).put("value", sizesString[which]);
							mAdapter.notifyDataSetChanged();
			...
			case 3: // ISO ***** Not every device support!
				// Test
			...
			case 4: // Path
				...
				.setPositiveButton(res.getString(R.string.ok), new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialog, int which) {
						...
						((HashMap<String, String>)adapterView.getItemAtPosition(4)).put("value", mPath);
						mAdapter.notifyDataSetChanged();
					}
				})
			...
			case 5: // Image type
				...
				.setItems(imageTypes, new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialog, final int which) {
						...
						((HashMap<String, String>)adapterView.getItemAtPosition(5)).put("value", imageTypes[mImageType + 1]);
						mAdapter.notifyDataSetChanged();
					}
				})
				.create()
			...
			case 7: // Preview
				...
				((HashMap<String, String>)adapterView.getItemAtPosition(7)).put("value", res.getString(mPreview ? R.string.yes : R.string.no));
				mAdapter.notifyDataSetChanged();
			...
			case 8: // Keep scale
				...
				((HashMap<String, String>)adapterView.getItemAtPosition(8)).put("value", res.getString(mKeepScale ? R.string.yes : R.string.no));
				mAdapter.notifyDataSetChanged();
				break;
				
			case 9: // Min face size
				showSeekBarDialog(res.getString(R.string.min_face_size), 20, 
					...
					public void onClick(int progress) {
						...
						((HashMap<String, String>)adapterView.getItemAtPosition(9)).put("value", Integer.toString(mMinFaceSize));
						mAdapter.notifyDataSetChanged();
					}
				});
				break;
			...
			case 10: // Scale factor
				...
				.setPositiveButton(res.getString(R.string.ok), new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialog, int which) {
						...
						((HashMap<String, String>)adapterView.getItemAtPosition(10)).put("value", Float.toString(mScaleFactor));
						mAdapter.notifyDataSetChanged();
					}
				})
				.setNegativeButton(res.getString(R.string.cancel), null)
			...
			case 11: // Debug mode
				...
				((HashMap<String, String>)adapterView.getItemAtPosition(11)).put("value", res.getString(mDebugMode ? R.string.yes : R.string.no));
				mAdapter.notifyDataSetChanged();
				break;
			}
		}
	...
	public static void onActivityResult(int requestCode, int resultCode, Intent data) {
		if (requestCode == 0 && resultCode == Activity.RESULT_OK)
		{
			...
			((HashMap<String, String>)mAdapter.getItem(6)).put("value", mImagePath);
			mAdapter.notifyDataSetChanged();
